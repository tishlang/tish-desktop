...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@tishlang/tish-desktop-api/web": path.resolve(
        root,
        "packages/desktop-api/src/web-bridge.js"
      ),
      "@tishlang/tish-desktop-api/web-bridge": path.resolve(
        root,
        "packages/desktop-api/src/web-bridge.js"
      ),
      "@tishlang/tish-app-api/web": path.resolve(
        root,
        "packages/desktop-api/src/web-bridge.js"
      ),
      "@tishlang/tish-app-api/web-bridge": path.resolve(
        root,
        "packages/desktop-api/src/web-bridge.js"
      ),
